...
public class ObjectivesServiceIntegrationTest {

    private final String baseUrl;

    public ObjectivesServiceIntegrationTest(@Value("${inevolving.uri.ms.objectives}") String fullUrl) throws URISyntaxException {
