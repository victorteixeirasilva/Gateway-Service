...
public class MotivationServiceIntegrationTest {

    private final String baseUrl;

    public MotivationServiceIntegrationTest(@Value("${inevolving.uri.ms.motivation}") String fullUrl) throws URISyntaxException {
